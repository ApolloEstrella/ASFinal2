    ...
    <div className={classes.root}>
      <Formik
        ...
        validationSchema={Yup.object().shape({
          ...
          rowLines: Yup.array().of(
            Yup.object().shape({
              salesItemId: Yup.string().nullable().required("Sales Item is required"),
            })
          ),
        })}
